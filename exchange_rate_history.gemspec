Gem::Specification.new do |s|
  ...
  s.description = "A ruby gem for storing and calculating foreign exchange rates. This implementation uses 90-day FX rate data, published daily by the ECB."
  ...
  s.executables = ["erh_store_updater"]
  s.homepage    =
